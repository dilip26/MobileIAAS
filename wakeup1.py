...
if len(tokens) == 2:
    ...
    os.chdir("/erase")
    print "in storage "
    print "sending Ack "+"scp /erase/" + files[0] + " root@192.168.12.1:/ack"
    os.popen("scp /erase/" + files[0] + " root@192.168.12.1:/ack")  # code for ACK
    ...
    if a != 1:
        ...
        print "scp " + str(newname[0:-1]) + " root@" + str(a) + ":/erase/"
